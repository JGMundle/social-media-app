...
const Followers = () => {
  ...
  return (
    <div>
      <div className="text-gray-500 text-sm mb-2" style={{ width: "100%" }}>
        <p>This Month</p>
      </div>
      <div className="display: flex flex-row items-center  hover:bg-gray-100 cursor-pointer p-2">
        <img
          src="src/assets/ProfilePicJuewell.jpg"
          width={45}
          height={25}
        ...
        <div className="ml-28">
          {isFollowing ? (
            <button
              ...
              className="border border-b-gray-500 px-3 py-"
            >
              Following
            </button>
          ) : (
